<%@page import="ecolage.EcolageNiveau"%>
<% 
    EcolageNiveau[] ecolage = new EcolageNiveau().getList();
%>
            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-body">
                  <table class="table table-bordered">
                      ...
                      <% for(int i=0; i<ecolage.length; i++) { %>
                      <tr>
                        <td><% out.println(ecolage[i].getClasseNom()); %></td>
                        <td><% out.println(ecolage[i].getEcolage()); %></td>
                      </tr>
                      <% } %>
                </table>
              </div>
