    ...
    <div class="container">    
        <div class="row">
            <div class="col-md-2">
                <div class="sidebar">
              <ul class="nav_list">
                <li class="active"><a href="index.jsp">Ecolage</a></li>
                ...
                <div class="containerBar">
                  ...
                  <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                      ...
                      <li><a href="elevenote.jsp">Etudiant</a></li>
                    </ul>
            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-body">
                <h1>Choisissez la classe</h1>
                <form class="form-group" action="">
                      <ul>
                          <li><a href="#">2nd A</a></li>                          
                          <li><a href="#">2nd B</a></li>
                          <li><a href="#">1ere L</a></li>
                          <li><a href="#">1ere S</a></li>
                          <li><a href="#">Terminal L</a></li>
                          <li><a href="#">Terminal S</a></li>
                      </ul>
                </form>
              </div>
