            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-body">
                  <form action="Enregistrement" method="post">
                    ...
                    <p>Matricule :<input type="text" name="ideleve"></p>
                    <p>Matiere :<input type="text" name="idmatiere"></p>
                    <p>note :<input type="text" name="point"></p>
                    <p>Date de l'examen <input type="date" name="dateexamen"></p>
